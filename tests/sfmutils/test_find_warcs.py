...
class TestFindWarcs(tests.TestCase):
    ...
    def test_find_warcs(self, mock_api_client_cls, mock_sys):
        ...
        self.assertEqual([call(exclude_web=True, harvest_date_end=None, harvest_date_start=None, collection_id='abc123'),
                          call(exclude_web=True, harvest_date_end=None, harvest_date_start=None, collection_id='def456')],
    ...
    def test_find_warcs_with_args(self, mock_api_client_cls, mock_sys):
        ...
        self.assertEqual(
            [call(exclude_web=False, harvest_date_end='2016-02-22T14:49:07Z', harvest_date_start='2015-02-22T14:49:07Z',
                  collection_id='abcdefghijklmnopqrstuvwxyz012345'),
             call(exclude_web=False, harvest_date_end='2016-02-22T14:49:07Z', harvest_date_start='2015-02-22T14:49:07Z',
